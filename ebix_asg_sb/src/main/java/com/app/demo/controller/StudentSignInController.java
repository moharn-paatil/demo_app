...
import com.app.demo.dto.AuthRequest;
import com.app.demo.dto.AuthResp;
import com.app.demo.dto.StudentDto;
import com.app.demo.jwt.Jwt;
...
//dep : JWT utils : for generating JWT
	...
	@PostMapping("/signup")
	public ResponseEntity<?> userRegistration(@RequestBody @Valid StudentDto student)
	{
